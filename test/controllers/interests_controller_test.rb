...
class InterestsControllerTest < ActionController::TestCase
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post :create, interest: { outstanding: @interest.outstanding, owing: @interest.owing, paying: @interest.paying }
    end
  ...
  test "should update interest" do
    patch :update, id: @interest, interest: { outstanding: @interest.outstanding, owing: @interest.owing, paying: @interest.paying }
    assert_redirected_to interest_path(assigns(:interest))
  end
